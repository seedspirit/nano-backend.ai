...
func TestErrorNotFound(t *testing.T) {
	...
	want := "runtime status " + id.String() + ": runtime not found"
	if err.Error() != want {
...
func TestErrorAlreadyExists(t *testing.T) {
	...
	want := "runtime create " + id.String() + ": runtime already exists"
	if err.Error() != want {
		t.Errorf("got %q, want %q", err.Error(), want)
	}
}
...
func TestErrorRuntime(t *testing.T) {
	...
	want := "runtime create: runtime error"
	if err.Error() != want {
		t.Errorf("got %q, want %q", err.Error(), want)
	}
}
...
func TestErrorWithZeroID(t *testing.T) {
	...
	want := "runtime destroy: runtime not found"
	if err.Error() != want {
		t.Errorf("got %q, want %q", err.Error(), want)
	}
}
