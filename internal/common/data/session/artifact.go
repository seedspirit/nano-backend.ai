...
// ArtifactIndex records the files produced by a Session.
//
// Every Session writes a fixed set of files (spec.yaml, resolved_config.yaml,
...
// NewArtifactIndex creates an ArtifactIndex for the given Session rooted at basePath.
// The Files slice starts empty; entries are appended as files are written.
func NewArtifactIndex(sessionID uuid.UUID, basePath string) ArtifactIndex {
