// Package kernel defines the minimal manager-agent execution contract: the
// CreationSpec an agent prepares and starts, the Launcher port the manager drives, and
// the ID that routes follow-up calls. It is transport- and substrate-agnostic:
