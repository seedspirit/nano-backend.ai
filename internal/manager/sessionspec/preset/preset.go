...
import (
	...
	commonpreset "github.com/seedspirit/nano-backend.ai/internal/common/data/session/preset"
)

// ID is the stable identity for a preset.
type ID = commonpreset.ID

// Preset is the resolved preset contract used while building session specs.
...
// RuntimeSpec describes how a preset is materialized by a kernel runtime.
